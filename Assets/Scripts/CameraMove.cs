...
//            if (m.transform.position.y < 15 && player.transform.position.y > m.transform.position.y && player.transform.position.y % 10 >= 9.9) // moving up
//            {
...
//            }
//            else if ( player.transform.position.y < m.transform.position.y && player.transform.position.y % 10 <= 0.2 ) //moving down to next screen
//            {
...
//        {
//            Debug.Log(m.transform.position.y < 15 );
//            Debug.Log(player.transform.position.y > m.transform.position.y);
//            Debug.Log(player.transform.position.y % 10 <= -1);
//            if ( player.transform.position.y > m.transform.position.y && player.transform.position.y % 10 >= -0.2) // moving up to next screen
//            {
...
//            }
//            else if (m.transform.position.y > -15 && player.transform.position.y < m.transform.position.y && player.transform.position.y % 10 <= -9.9) //moving down to next screen
//            {
